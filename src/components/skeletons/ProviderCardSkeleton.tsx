    ...
    <Card className="animate-pulse">
      <div className="flex flex-col md:flex-row items-start space-y-4 md:space-y-0 md:space-x-6">
        ...
        <div className="flex-grow w-full">
          <div className="h-7 bg-cinza-neutro/30 rounded w-3/4 mb-2"></div>
          <div className="h-5 bg-cinza-neutro/30 rounded w-1/2 mb-3"></div>
          <div className="h-4 bg-cinza-neutro/30 rounded w-1/3 mb-4"></div>
